...
public class AES256EX {
    ...
    public AES256EX(final String key) {
        this(key, 128);
    }

    public AES256EX(final String key, final int bit) {
        this(key, bit, null);
    }

    public AES256EX(final String key, final int bit, final String iv) {
        if (bit == 256) {
